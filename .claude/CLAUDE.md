...
- Booking form emails via Resend to `rootsinbluestone@gmail.com`; needs `RESEND_API_KEY` and optionally `BOOKING_FROM_EMAIL`, and degrades gracefully without Resend. Never commit secrets.
